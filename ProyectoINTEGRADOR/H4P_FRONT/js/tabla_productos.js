const { createApp } = Vue
  ...
  createApp({
    data() {
      return {
        url:"https://happy4pet.pythonanywhere.com/productos", // Retorna todos los registro de la tabla productos
        productos:[],
        error:false,
        cargando:true
      }
    ...
    methods: {
        ...
        eliminar(id) {
            ...
            const url = 'https://happy4pet.pythonanywhere.com/borrar/'+id;
            var options = {
                method: 'DELETE',
